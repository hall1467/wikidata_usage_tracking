...
# psql wikidata_entities -U hall < $base/revisions_all_automation_flags_and_usages_table/revisions_all_automation_flags_and_usages_table_creation.sql
 # psql wikidata_entities -U hall < $base/revisions_all_automation_flags_and_usages_table/revisions_all_automation_flags_and_usages_table_update_nulls.sql
...
# reran this one command manually
...
# # For chork
# cat all_used_edits_sampled_sub01 | \
# 	ores score_revisions https://ores.wikimedia.org wikidata_alignment_research_1 wikidatawiki itemquality \
# 	> all_used_edits_sampled_sub01_predictions.json

# # For spork
# cat all_used_edits_sampled_sub02 | \
# 	ores score_revisions https://ores.wikimedia.org wikidata_alignment_research_2 wikidatawiki itemquality \
# 	> all_used_edits_sampled_sub02_predictions.json

# # For stockholm
# cat all_used_edits_sampled_sub03 | \
# 	ores score_revisions https://ores.wikimedia.org wikidata_alignment_research_3 wikidatawiki itemquality \
# 	> all_used_edits_sampled_sub03_predictions.json
