...
# split -d -l 280000 $results/all_used_edits_sampled.json $results/all_used_edits_sampled_sub
# split -d -l 280000 $results/all_used_edits_parent_rev_ids_sampled.json $results/all_used_edits_parent_rev_ids_sampled_sub
