...
for (monthly_distribution_and_edits in list(
    ...
    # revisions$quality_difference = as.numeric(revisions$parent_weighted_sum) - revisions$expected_quality
    revisions$quality_difference = ifelse(revisions$parent_weighted_sum != 'NULL', as.numeric(revisions$parent_weighted_sum) - revisions$expected_quality, NA)
