CREATE TABLE revisions_with_interesting_subset_info_table_creation AS (
	SELECT revisions_with_human_male_and_female_genders.*, coordinate_location_items_12_29_18.coordinate_location AS coordinate_location
	FROM
	(
	...
	) AS revisions_with_human_male_and_female_genders
	LEFT JOIN
	coordinate_location_items_12_29_18
	ON revisions_with_human_male_and_female_genders.page_title = coordinate_location_items_12_29_18.page_title
