...
Usage:
    registered_users_predictor_and_inter_edit_construction (-h|--help)
    registered_users_predictor_and_inter_edit_construction <input> <predictor_output> <inter_edit_output>
                                                           [--debug]
                                                           [--verbose]
...
def main(argv=None):
    ...
    predictor_output_file = mysqltsv.Writer(
        ...
        headers=['user', 'username', 'session_start', 'mean_in_seconds', 
    ...
    inter_edit_output_file = mysqltsv.Writer(
        ...
        headers=['user', 'session_start', 'inter_edit'])
...
def run(input_file, predictor_output_file, inter_edit_output_file, verbose):
    ...
    for user in agg_stats:
        for session_start in agg_stats[user]:
            ...
            for inter_edit in inter_edit_times[user][session_start]:
