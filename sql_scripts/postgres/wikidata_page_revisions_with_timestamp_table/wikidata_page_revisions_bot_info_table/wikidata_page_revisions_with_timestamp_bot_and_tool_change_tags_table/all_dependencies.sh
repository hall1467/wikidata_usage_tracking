...
set entity_monthly_types_of_semi_automated_edits_table_directory = $wikidata_page_revisions_with_timestamp_bot_and_tool_change_tags_table/used_entity_previous_month_edits_table
set wikidata_page_revisions_with_timestamp_edit_types_and_usage_table_directory = $wikidata_page_revisions_with_timestamp_bot_and_tool_change_tags_table/misalignment_and_edits_table
