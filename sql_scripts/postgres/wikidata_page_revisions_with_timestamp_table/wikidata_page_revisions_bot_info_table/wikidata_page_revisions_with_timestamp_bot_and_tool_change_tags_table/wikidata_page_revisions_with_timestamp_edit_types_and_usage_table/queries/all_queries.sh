...
cp $wikidata_page_revisions_with_timestamp_edit_types_and_usage_sql_results_directory/human_property_edits.sql $wikidata_page_revisions_with_timestamp_edit_types_and_usage_processing_results_directory
