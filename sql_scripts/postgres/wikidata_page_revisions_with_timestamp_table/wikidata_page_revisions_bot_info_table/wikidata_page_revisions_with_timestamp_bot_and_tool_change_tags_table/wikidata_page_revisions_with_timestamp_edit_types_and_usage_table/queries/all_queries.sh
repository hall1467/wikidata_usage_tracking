...
echo "edit_type\tuser\ttimestamp\trevision_id" > $wikidata_page_revisions_with_timestamp_edit_types_and_usage_processing_results_directory/human_edits_with_header.tsv

cat $wikidata_page_revisions_with_timestamp_edit_types_and_usage_processing_results_directory/all_edits_for_used_entities.tsv >> $wikidata_page_revisions_with_timestamp_edit_types_and_usage_processing_results_directory/human_edits_with_header.tsv
