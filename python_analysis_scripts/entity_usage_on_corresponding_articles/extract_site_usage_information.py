"""
Extract site usage information from an (gross, icky) SQL file.

Usage:
    extract_site_usage_information (-h|--help)
    extract_site_usage_information [<sql-file>]...
                                   [--processes=<num>]
                                   [--debug]
                                   [--verbose]
...
from site_usage_dump import SiteDump
